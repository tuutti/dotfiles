...
" Generated by http://bytefluent.com/vivify 2013-06-10
set background=dark
if version > 580
	hi clear
	if exists("syntax_on")
...
hi TabLineSel guifg=#000000 guibg=#272727 guisp=#272727 gui=italic ctermfg=NONE ctermbg=2 cterm=NONE
...
hi PMenuSel guifg=#101010 guibg=#272727 guisp=#272727 gui=NONE ctermfg=233 ctermbg=255 cterm=NONE
...
hi TabLineFill guifg=#272727 guibg=NONE guisp=NONE gui=NONE ctermfg=0 ctermbg=NONE cterm=NONE
...
hi TabLine guifg=#000000 guibg=#272727 guisp=#272727 gui=italic ctermfg=NONE ctermbg=NONE cterm=NONE
