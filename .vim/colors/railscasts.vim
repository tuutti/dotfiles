...
hi CursorLineNr              guifg=#bbbbbb ctermfg=172
...
"rubyComment
hi Comment                   guifg=#BC9458 gui=italic ctermfg=102
hi Todo                      guifg=#BC9458 guibg=NONE gui=italic ctermfg=94

"rubyPseudoVariable
"nil, self, symbols, etc
hi Constant                  guifg=#df8700 ctermfg=172
...
"rubyFunction
hi Function                  guifg=#FFC66D gui=NONE ctermfg=222 cterm=NONE

"rubyIdentifier
"@var, @@var, $var, etc
hi Identifier                guifg=#afd7d7 gui=NONE ctermfg=152 cterm=NONE
